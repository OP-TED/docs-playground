...
.TED Open Data
****
Query and connect to TED Open Data using SPARQL. Convert notice XML documents to RDF we create appropriate using RML (the RDF Mapping Language). Reuse TED Data from the TED Website
